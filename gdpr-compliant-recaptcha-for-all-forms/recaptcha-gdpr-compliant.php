...
class RCM_Main {
	...
	public static function get_instance() {
		// WELCHE Klassen es gibt und in welcher Reihenfolge sie geladen werden, steht seit
		// dem Dateigroessen-Schnitt in includes/load-classes.php — diese Datei hier haelt den
		// Lebenszyklus, nicht die Dateiliste.
		require_once __DIR__ . '/includes/load-classes.php';
